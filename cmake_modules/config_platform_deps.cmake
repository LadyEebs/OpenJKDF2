...
if (NOT TARGET_USE_BASICSOCKETS AND NOT TARGET_USE_GAMENETWORKINGSOCKETS AND NOT TARGET_USE_STEAMWORKS)
...
if(TARGET_USE_STEAMWORKS)
    include_directories(${PROJECT_SOURCE_DIR}/3rdparty/steamworks-162/public/steam)
    file(GLOB TARGET_STEAM_SRCS ${PROJECT_SOURCE_DIR}/src/Modules/std/Steam/*.cpp)
    list(APPEND ENGINE_SOURCE_FILES ${TARGET_STEAM_SRCS})

    add_compile_definitions(PLATFORM_STEAM)
endif()
