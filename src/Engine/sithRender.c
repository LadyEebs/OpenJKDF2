...
int sithRender_RenderThing(sithThing *pThing)
{
	...
	if (showPhysicsJoints)
	{
		...
		while (jointBits != 0)
		{
			...
			#ifdef RIGID_BODY
				rdSprite debugSprite;
				rdSprite_NewEntry(&debugSprite, "dbgragoll", 0, "sabergreen0.mat", pJoint->thing.moveSize * 0.5f, pJoint->thing.moveSize * 0.5f, RD_GEOMODE_TEXTURED, RD_LIGHTMODE_FULLYLIT, RD_TEXTUREMODE_AFFINE, 1.0f, &rdroid_zeroVector3);
