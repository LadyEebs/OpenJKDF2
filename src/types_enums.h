...
enum JOINTTYPE
{
	...
	JOINTTYPE_RFOREARM           = 9,
	JOINTTYPE_LFOREARM           = 10,
	JOINTTYPE_RCALF              = 11,
	JOINTTYPE_LCALF              = 12,
	JOINTTYPE_NUM_JOINTS,

	JOINTTYPE_RTHIGH             = JOINTTYPE_TURRETPITCH,
	JOINTTYPE_LTHIGH             = JOINTTYPE_TURRETYAW,
	JOINTTYPE_RHAND              = JOINTTYPE_PRIMARYWEAP,
	JOINTTYPE_LHAND              = JOINTTYPE_SECONDARYWEAP,
	JOINTTYPE_RSHOULDER          = JOINTTYPE_PRIMARYWEAPJOINT,
	JOINTTYPE_LSHOULDER          = JOINTTYPE_SECONDARYWEAPJOINT,
#else
