...
#ifdef TILE_SW_RASTER
#define STD3D_MAX_VIDEO_MODES        256

#define STDPAL_CUBE_DIM 16
#define STDPAL_CUBE_SIZE (STDPAL_CUBE_DIM*STDPAL_CUBE_DIM*STDPAL_CUBE_DIM)

#define RDCACHE_MAX_TILE_TRIS        (RDCACHE_MAX_TRIS)// * 30)
...
#define RDCACHE_TILE_BINNING_STRIDE  ((RDCACHE_MAX_TILE_TRIS+31) / 32)
#define RDCACHE_FINE_PER_COARSE      RDCACHE_TILE_DOWNSAMPLE
#else
#define STD3D_MAX_VIDEO_MODES 64
#endif
