...
MATH_FUNC void sithCollision_BuildCollisionList(sithSector *a1, const rdVector3 *a2, const rdVector3 *a3, flex_t a4, flex_t a5, int raycastFlags);
...
static void (*sithCollision_BuildCollisionList)(sithSector *a1, rdVector3 *a2, rdVector3 *a3, flex_t a4, flex_t a5, int raycastFlags) = (void*)sithCollision_BuildCollisionList_ADDR;
