...
MATH_FUNC int rdVector_IsNotZero3(rdVector3* v);
...
MATH_FUNC void rdVector_NormalizeDeltaAngle3(rdVector3* v, const rdVector3* a, const rdVector3* b);
...
MATH_FUNC void rdVector_Clamp3(rdVector3* v, const rdVector3* minVal, const rdVector3* maxVal);
MATH_FUNC void rdVector_Reflect3(rdVector3* v, const rdVector3* incidentVec, const rdVector3* normal);
MATH_FUNC void rdVector_Average3(rdVector3* out, rdVector3* a, rdVector3* b, rdVector3* c);
MATH_FUNC void rdVector_Lerp3(rdVector3* out, rdVector3* a, rdVector3* b, flex_t f);
MATH_FUNC void rdVector_Project3(rdVector3* out, rdVector3* p, rdVector3* o, rdVector3* n);
MATH_FUNC void rdVector_ProjectDir3(rdVector3* out, rdVector3* v, rdVector3* n);
MATH_FUNC int rdVector_Compare3(const rdVector3* a, const rdVector3* b);
MATH_FUNC int rdVector_Compare4(const rdVector4* a, const rdVector4* b);
MATH_FUNC void rdVector_ToPYR(rdVector3* pyr, const rdVector3* v);
MATH_FUNC void rdVector_FromPYR(rdVector3* v, const rdVector3* pyr);
