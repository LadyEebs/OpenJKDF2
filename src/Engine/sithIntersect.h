...
MATH_FUNC int sithIntersect_TreeIntersection(rdHierarchyNode *paNodes,rdVector3 *pPoseVec,rdVector3 *pDirVec,flex_t a4,flex_t range, sithThing *v11,flex_t *pOut,rdVector3 *pOutVec, rdHierarchyNode** outNode, int raycastFlags, rdVector3* pRefDir);
MATH_FUNC // sithIntersect_sub_508370
MATH_FUNC int sithIntersect_MeshIntersection(rdVector3 *a1, rdVector3 *a2, flex_t a3, flex_t a4, rdMesh *mesh, flex_t *a6, rdFace **faceOut, rdVector3 *a8);
...
MATH_FUNC int sithIntersect_FaceIntersection(rdVector3 *a1, flex_t a2, rdFace *a3, rdVector3 *a4, int *a5);
...
MATH_FUNC int sithIntersect_sub_508D20(const rdVector3 *a1, const rdVector3 *a2, flex_t a3, flex_t a4, rdFace *a5, rdVector3 *a6, flex_t *a7, rdVector3 *a8, int a9);
