...
int sithDSSCog_SendSendTrigger(sithCog *a1, int a2, int a3, int a4, int a5, int a6, int a7, flex32_t param0, flex32_t param1, flex32_t param2, flex32_t param3, DPID a11)
{
    int v12; // edi
    sithThing *v13; // eax
    sithThing *v14; // eax
