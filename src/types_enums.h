...
enum JOINTTYPE
{
	...
	JOINTTYPE_HIP                = 9,
	JOINTTYPE_RSHOULDER          = 10,
	JOINTTYPE_LSHOULDER          = 11,
	JOINTTYPE_RFOREARM           = 12,
	JOINTTYPE_LFOREARM           = 13,
	JOINTTYPE_RHAND              = 14,
	JOINTTYPE_LHAND              = 15,
	JOINTTYPE_RTHIGH             = 16,
	JOINTTYPE_LTHIGH             = 17,
	...
	JOINTTYPE_LFOOT              = 21,
#ifdef PUPPET_PHYSICS
	JOINTTYPE_TAIL_BASE          = 22,
	JOINTTYPE_TAIL_MID           = 23,
	JOINTTYPE_TAIL_TIP           = 24,
	JOINTTYPE_CLOAK_BASE         = 25,
	JOINTTYPE_CLOAK_MID          = 26,
	JOINTTYPE_CLOAK_TIP          = 27,
	JOINTTYPE_WING_BASE          = 28,
	JOINTTYPE_WING_MID           = 29,
	JOINTTYPE_WING_TIP           = 30,
	JOINTTYPE_SKIRT_FRONT        = 31,
	JOINTTYPE_SKIRT_BACK         = 32,
	JOINTTYPE_SKIRT_LEFT         = 33,
	JOINTTYPE_SKIRT_RIGHT        = 34,
	JOINTTYPE_CAPE_TOP           = 35,
	JOINTTYPE_CAPE_MID           = 36,
	JOINTTYPE_CAPE_BOTTOM        = 37,
	JOINTTYPE_BELT_FRONT         = 38,
	JOINTTYPE_BELT_BACK          = 39,
	JOINTTYPE_BELT_LEFT          = 40,
	JOINTTYPE_BELT_RIGHT         = 41,
	JOINTTYPE_PONYTAIL_BASE      = 42,
	JOINTTYPE_PONYTAIL_MID       = 43,
	JOINTTYPE_PONYTAIL_TIP       = 44,
#endif
	JOINTTYPE_NUM_JOINTS,
#else
	JOINTTYPE_NUM_JOINTS         = 10, // original defined 10 but 9 was unused?
#endif
};
...
{
	JOINTFLAGS_NONE     = 0x0,
	JOINTFLAGS_PHYSICS  = 0x1,
	JOINTFLAGS_PINNED   = 0x2,
	JOINTFLAGS_ROOT     = 0x4,
	JOINTFLAGS_BOUNCE   = 0x8,
};

enum SITH_PUPPET_FLAGS
{
	SITH_PUPPET_NONE    = 0x0,
	SITH_PUPPET_PHYSICS = 0x1,
};
...
enum sithMultiModeFlags
{
    ...
    MULTIMODEFLAG_NO_FRIENDLY_FIRE = 0x2,
	MULTIMODEFLAG_CUSTOM_SCORING = 0x4,
    MULTIMODEFLAG_TIMELIMIT = 0x8,
    MULTIMODEFLAG_SCORELIMIT = 0x10,
    MULTIMODEFLAG_NO_SKINS = 0x20,
    MULTIMODEFLAG_40 = 0x40,
    MULTIMODEFLAG_SINGLE_LEVEL = 0x80,
    MULTIMODEFLAG_AUTO_TEAM = 0x100,
    MULTIMODEFLAG_NO_TEAM_TALLY = 0x200,
...
#ifdef PLATFORM_STEAM
	MULTIMODEFLAG_FRIENDS_ONLY = 0x20000,
	MULTIMODEFLAG_PROXIMITY_CHAT = 0x40000,
#endif
};
...
enum THINGPARAM
{
	...
	#ifdef RENDER_DROID2
	THINGPARAM_LIGHTRADIUS,
	THINGPARAM_LIGHTANGLE,
	THINGPARAM_LIGHTSIZE,
	#endif
#endif
    THINGPARAM_ATTACH,
